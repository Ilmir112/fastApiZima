...
def downgrade() -> None:
    ...
    sa.Column('start_well_repair', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('repair_well_repair', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('type_tkrs', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('summary_work', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.Column('norms_json', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['creater_id'], ['users.id'], name='norms_creater_id_fkey'),
    sa.ForeignKeyConstraint(['repair_id'], ['wells_repairs.id'], name='norms_repair_id_fkey'),
    ...
    sa.Column('brigade_master', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('phone_number_brigade', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('lifting_unit', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('hydraulic_wrench', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('weight_indicator', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('brigade_composition', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True),
