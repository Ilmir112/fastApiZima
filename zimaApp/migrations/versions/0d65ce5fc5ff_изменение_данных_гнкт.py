"""изменение данных гнкт

Revision ID: 0d65ce5fc5ff
Revises: 
Create Date: 2025-05-28 14:42:15.147781
...
def upgrade() -> None:
    ...
    sa.Column('mileage_gnkt', sa.Integer(), nullable=False),
    ...
    sa.Column('pvo_number', sa.Integer(), nullable=False),
    ...
    sa.Column('leakiness', sa.JSON(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('wells_id', sa.Integer(), nullable=True),
    ...
    sa.Column('geolog_id', sa.Integer(), nullable=True),
    sa.Column('date_create', sa.Date(), nullable=False),
    sa.Column('perforation_project', sa.JSON(), nullable=True),
    sa.Column('type_absorbent', sa.String(), nullable=True),
    sa.Column('static_level', sa.Float(), nullable=True),
    sa.Column('dinamic_level', sa.Float(), nullable=True),
    sa.Column('expected_data', sa.JSON(), nullable=False),
    sa.Column('curator', sa.String(), nullable=False),
    sa.Column('region', sa.String(), nullable=False),
    sa.Column('contractor', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['geolog_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['wells_id'], ['wells_data.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
